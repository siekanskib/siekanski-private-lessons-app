...
namespace siekanski_private_lessons_backend.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "HomeworkTaskContentMaterials",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkTaskContentMaterials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HomeworkTaskContentMaterials_HomeworkTasks_HomeworkTaskId",
            ...
            migrationBuilder.CreateTable(
                name: "HomeworkTaskFeedbackMaterials",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkTaskFeedbackMaterials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HomeworkTaskFeedbackMaterials_HomeworkTasks_HomeworkTaskId",
                        column: x => x.HomeworkTaskId,
                        principalTable: "HomeworkTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "HomeworkTaskSolutionMaterials",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkTaskSolutionMaterials", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HomeworkTaskSolutionMaterials_HomeworkTasks_HomeworkTaskId",
                        column: x => x.HomeworkTaskId,
                        principalTable: "HomeworkTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkTaskContentMaterials_HomeworkTaskId",
                table: "HomeworkTaskContentMaterials",
                column: "HomeworkTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeworkTaskFeedbackMaterials_HomeworkTaskId",
                table: "HomeworkTaskFeedbackMaterials",
                column: "HomeworkTaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkTaskSolutionMaterials_HomeworkTaskId",
                table: "HomeworkTaskSolutionMaterials",
                column: "HomeworkTaskId");
